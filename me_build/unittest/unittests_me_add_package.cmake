...
me_add_package(
    TestUnit
    PUBLIC_HEADER_DIR subdir
    PUBLIC_HEADERS Interface1.hpp Interface2.hpp
)
...
me_add_package(
    ...
    SOURCE_DIR subdir
    SOURCES Source1.cpp Source2.cpp
    SOURCE_DEPENDS InterfaceA InterfaceB
)

me_cmake_test_end()

me_cmake_test_begin(test_me_add_interface_package_dir_depends_source_dir_depends)
...
me_add_package(
    TestUnit
    PUBLIC_HEADER_DIR isubdir
    PUBLIC_HEADERS Interface1.hpp Interface2.hpp
    PUBLIC_HEADER_DEPENDS iInterfaceA iInterfaceB
    SOURCE_DIR ssubdir
    SOURCES Source1.cpp Source2.cpp
    SOURCE_DEPENDS sInterfaceA sInterfaceB
)
